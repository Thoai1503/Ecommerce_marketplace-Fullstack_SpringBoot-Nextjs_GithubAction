...
--
-- Host: mysql-2acda025-vothoai1503-2915.l.aivencloud.com    Database: logistic_service
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=133 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Thông tin người nhận hàng (snapshot tại thời điểm tạo shipment)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recipient` VALUES (128,'Vo Giang Thoai','0862830787','vpthpo@gmail.com','341 Cao Thang',2,4,5,'2026-03-27 06:17:02'),(129,'Vo Quang Teo','0869990787',NULL,'341 Cao Thang',2,4,5,'2026-03-28 12:31:36'),(131,'Vo Quang Teo Em','0860000787',NULL,'341 Cao Thang',2,4,5,'2026-03-28 12:45:43'),(132,'dvzsx','0987654243',NULL,'dvsvsv',1,1,1,'2026-03-29 22:25:44');
...
) ENGINE=InnoDB AUTO_INCREMENT=239 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Vận đơn - đơn vị trung tâm của logistics service';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=197 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Sản phẩm trong vận đơn (snapshot, không join về ecommerce DB)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-31 21:10:52
