      ...
      <div className="flex items-center gap-3 lg:gap-5">
              ...
              {themeOptions.map((option) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      className={
                        theme === option.id ? "text-white" : "text-slate-500"
                      }
                    >
                      {option.icon}
                    </span>
                  ...
                  {theme === option.id && (
                    <Check size={16} className="text-blue-200 stroke-[3px]" />
                  )}
                </button>
              ))}
            </div>
        ...
        <div className="relative" ref={profileDropdownRef}>
          ...
          >
            ...
            <ChevronDown
              size={16}
              className={`text-slate-400 transition-transform duration-300 ${isProfileOpen ? "rotate-180 text-blue-600" : "group-hover:text-blue-600"}`}
            />
          </button>
