...
export default function Sidebar() {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      submenu: [
        { label: "Kênh Marketing", href: "/admin/marketing" },
        { label: "Đấu Giá Rẻ Vô Địch", href: "/admin/marketing/auction" },
        {
          label: "Dịch Vụ Hiển Thị Shopee",
          href: "/admin/marketing/display",
        },
        { label: "Tăng Đơn Cùng KOL", href: "/admin/marketing/kol" },
        {
          label: "Live & Video",
          href: "/admin/marketing/live",
          badge: "NEW",
        },
      ],
    },
    {
      ...
      submenu: [
        { label: "Khuyến Mãi Của Shop", href: "/admin/promotions" },
        { label: "Mã Giảm Giá Của Shop", href: "/admin/promotions/vouchers" },
      ],
    },
    {
      id: "finance",
      ...
      submenu: [
        { label: "Doanh Thu", href: "/admin/finance/revenue" },
        { label: "Số Dư TK Shopee", href: "/admin/finance/balance" },
        { label: "Báo Cáo Tài Chính", href: "/admin/finance/reports" },
      ],
    },
    {
      id: "data",
      ...
      submenu: [
        { label: "Phân Tích Bán Hàng", href: "/admin/data/sales" },
        { label: "Hiệu Quả Hoạt Động", href: "/admin/data/performance" },
      ],
    },
    {
      id: "shop",
      ...
      submenu: [
        { label: "Hồ Sơ Shop", href: "/admin/shop/profile" },
        { label: "Trang Trí Shop", href: "/admin/shop/decoration" },
        { label: "Đánh Giá Shop", href: "/admin/shop/ratings" },
      ],
    },
  ];
              ...
              <>
                <button
                  ...
                  className={`btn btn-link text-decoration-none text-dark d-flex align-items-center justify-content-between w-100 px-3 py-2 text-start hover-bg-light ${
                    menu.id === "products" ? "bg-danger bg-opacity-10" : ""
                  }`}
                >
                  <div className="d-flex align-items-center">
