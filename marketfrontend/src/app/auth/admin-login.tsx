...
const mapError = (err: unknown) => {
  ...
  if (code === "ROLE_NOT_ALLOWED") return "Tài khoản này không phải Admin";
    ...
    <div className="min-h-screen w-full flex bg-slate-50 font-sans text-slate-900">
      <div className="hidden lg:flex w-7/12 bg-[#0f172a] relative overflow-hidden flex-col justify-between p-16 text-white">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-[#0f172a] via-[#0f172a]/95 to-indigo-950/80 mix-blend-multiply" />
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-bold text-indigo-300 tracking-widest uppercase mt-1">
                Administrator
              </span>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-5 group">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Theo dõi sức khỏe hệ thống, lưu lượng truy cập và các chỉ số hiệu suất chính theo thời gian thực.
                </p>
              </div>
            </div>
        ...
        <div className="relative z-10 flex justify-between items-center text-xs font-bold text-slate-500 uppercase tracking-widest border-t border-white/5 pt-8">
          <span>© 2026 VietCommerce Hub Inc.</span>
        ...
        <div className="max-w-[420px] w-full bg-white p-8 lg:p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 relative">
          ...
          <form onSubmit={handleSubmit(handleLogin)} noValidate className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="admin@vietcommerce.com"
                />
            ...
            <div className="flex items-center justify-between gap-4 pt-1">
              ...
              <a href="/forgot-password" className="text-xs font-bold text-indigo-600 hover:text-indigo-700 hover:underline">
                Quên mật khẩu?
              </a>
            </div>
