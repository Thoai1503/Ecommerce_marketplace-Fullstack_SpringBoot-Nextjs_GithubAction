...
const getVoucherSubtext = (voucher: AdminVoucher) => {
  ...
  if (minOrder > 0) {
    if (minOrder >= 1000) return `For orders from ${Math.round(minOrder / 1000)}K`;
    ...
    return (
      ...
      >
        <div className="container" style={{ maxWidth: "1440px" }}>
          ...
          <div className="alert alert-danger mb-0">Unable to load voucher data.</div>
        </div>
      </div>
    );
  }
            ...
            return (
              <section key={issuerKey} className="mb-5">
                <div
                  ...
                  style={{ borderBottom: "1px solid rgba(220, 53, 69, 0.12)", paddingBottom: "10px" }}
                >
                  <h3 className="fw-semibold mb-0" style={{ fontSize: "1.05rem", color: "#b42318" }}>
                    {issuerMeta.title}
                  </h3>
                  <span
                    className="fw-medium"
                      ...
                      >
                              ...
                              <div className="d-flex h-100">
                                ...
                                >
                                  ...
                                  <div style={{ fontSize: "0.72rem" }}>shipping</div>
                                </div>
                                ...
                                <div className="flex-grow-1 p-3 p-md-4">
                                  <div className="d-flex align-items-start justify-content-between gap-3">
                                    <div className="flex-grow-1">
                                      ...
                                      <div
                                        ...
                                        style={{ fontSize: "0.84rem", maxWidth: "85%" }}
                                      >
                                  ...
                                  <div
                                    ...
                                    style={{ borderTop: "1px dashed rgba(255, 107, 107, 0.24)" }}
                                  >
