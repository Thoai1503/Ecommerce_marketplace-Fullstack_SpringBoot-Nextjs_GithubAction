        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-1">
              Configure attribute details and options.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div
                    onClick={() =>
                      setFormData({ ...formData, option: "DROPDOWN" })
                    }
                  ...
                  <div
                    onClick={() =>
                      setFormData({ ...formData, option: "RADIO" })
                    }
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-slate-400 flex items-center gap-1">
                  <AlertCircle size={10} /> Link to a unit (e.g. Weight - kg) to
                  display symbol automatically.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-200">
                  ...
                  >
                    <div
                      className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full shadow-sm transition-transform duration-300 ${formData.published ? "translate-x-6" : "translate-x-0"}`}
                    ></div>
                  </button>
                  <span
                    className={`text-sm font-bold ${formData.published ? "text-green-700" : "text-slate-500"}`}
                  >
          ...
          <div className="bg-white rounded-[24px] border border-slate-200 shadow-sm p-6">
            ...
            <div className="p-6 bg-slate-50 border border-slate-100 rounded-2xl flex flex-col items-center justify-center min-h-[200px]">
                  ...
                  <div className="space-y-2">
                    {["Option 1", "Option 2", "Option 3"].map((opt, i) => (
                      <div key={i} className="flex items-center gap-2">
                        <div
                          className={`w-4 h-4 rounded-full border flex items-center justify-center ${i === 0 ? "border-blue-500" : "border-slate-300 bg-white"}`}
                        >
                          {i === 0 && (
              ...
              <p className="text-[10px] text-slate-400 mt-8 text-center">
                Đây là minh họa cách hiển thị thuộc tính <br /> trên trang chi
                tiết sản phẩm.
              </p>
            </div>
          </div>
