...
CREATE TABLE `order_item` (
  ...
  `shop_voucher_discount_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `platform_voucher_discount_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `total_voucher_discount_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `total_after_shop_voucher` decimal(18,2) NOT NULL DEFAULT '0.00',
  `total_after_all_vouchers` decimal(18,2) NOT NULL DEFAULT '0.00',
  `platform_commission_rate` decimal(5,4) NOT NULL DEFAULT '0.0000',
  `platform_commission_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `seller_receivable_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
